public class Fifthasign {
	...
	public Fifthasign (String firstname, String lastname, String age, String designation) {
	...
	public static void main(String[] args) {
		Fifthasign Emp = new Fifthasign ("Prashant", "Dubey", "23", "Adobe manager");
